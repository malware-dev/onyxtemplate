...
public class DocumentSimpleMacroTests
{
    ...
    public void Parse_WithMixOfTextAndMacros_ShouldParseSuccessfully()
    {
        ...
        document.Blocks[0].Should().BeOfType<TextBlock>().Which.Text.Should().Be("Hello, ");
        document.Blocks[1].Should().BeOfType<SimpleMacroBlock>().Which.Field.Name.Should().Be("name");
        document.Blocks[2].Should().BeOfType<TextBlock>().Which.Text.Should().Be("!");
    }
    ...
    public void Parse_WithTaggedMacro_ShouldParseSuccessfully()
    {
        ...
        block1.Field.Name.Should().Be("name");
    ...
    public void Parse_WithUpDots_ShouldParseSuccessfully()
    {
        ...
        block2.Field.Name.Should().Be("name");
        block2.Field.Up.Should().Be(2);
        document.Blocks[4].Should().BeOfType<TextBlock>().Which.Text.Should().Be("?");
    }
}